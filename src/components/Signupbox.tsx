      ...
      <div className="p-8 sm:p-10 rounded-3xl bg-[#0D0F12] border border-white/[0.08] shadow-2xl backdrop-blur-xl relative">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-xs sm:text-sm text-[#94A3B8] mt-1.5">
            Join the circle and build genuine connections
          </p>
        </div>
        ...
        <form onSubmit={submit} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-[#181B21] border border-white/[0.08] focus-within:border-[#f59e0b]/60 transition-colors">
              <PersonOutlineIcon className="!text-[18px] text-[#64748B]" />
              <input
                className="w-full bg-transparent text-sm sm:text-base text-white placeholder:text-[#64748B] focus:outline-none"
                type="text"
                value={UserNameIn}
                onChange={(e) => SetUserNameIn(e.target.value.trimStart())}
                placeholder="arpit_dev"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-[#181B21] border border-white/[0.08] focus-within:border-[#f59e0b]/60 transition-colors">
              <BadgeOutlinedIcon className="!text-[18px] text-[#64748B]" />
              <input
                className="w-full bg-transparent text-sm sm:text-base text-white placeholder:text-[#64748B] focus:outline-none"
                type="text"
                value={NameIn}
                onChange={(e) => SetNameIn(e.target.value)}
                placeholder="Arpit Agrahari"
                required
              />
            </div>
          </div>
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-[#181B21] border border-white/[0.08] focus-within:border-[#f59e0b]/60 transition-colors">
              ...
              <input
                ...
                type="email"
                value={EmailIn}
                onChange={(e) => SetEmailIn(e.target.value.trimStart())}
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2.5 px-3.5 py-2.5 rounded-2xl bg-[#181B21] border border-white/[0.08] focus-within:border-[#f59e0b]/60 transition-colors">
              ...
              <input
                ...
                className="w-full bg-transparent text-sm sm:text-base text-white placeholder:text-[#64748B] focus:outline-none"
                value={PasswordIn}
                onChange={(e) => SetPasswordIn(e.target.value.trimStart())}
                placeholder="••••••••"
                required
              />
            </div>
