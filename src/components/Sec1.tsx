...
const Sec1 = () => {
  return (
   <>
    <div className='flex my-[5rem] flex-wrap items-center  justify-around max-[800px]:gap-[5rem]   ' >
        <div className='w-[50%] flex flex-col gap-[1.5rem] max-[800px]:w-[80%] max-[600px]:w-[95%] ' >
        ...
        <div className='w-[30%] max-[800px]:w-[50%]  max-[600px]:w-[70%]' >
