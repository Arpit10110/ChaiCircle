  ...
  return (
    <>
        <div className="my-[8rem] px-[2rem] " >
            <div className="flex flex-wrap justify-around  items-center max-[600px]:gap-[5rem] " >
                <div className="w-[50%] flex flex-col gap-[1rem] max-[800px]:w-[60%]  max-[600px]:w-[100%]  " >
            ...
            <div className="flex flex-wrap justify-around  items-center mt-[8rem] flex-row-reverse max-[600px]:gap-[5rem] " >
                <div className="w-[50%] flex flex-col gap-[1rem] max-[800px]:w-[60%] max-[600px]:w-[100%]  " >
