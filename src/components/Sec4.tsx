    ...
    <>
        <div className="my-[8rem]  " >
                ...
                <div className="mt-[5rem] flex flex-wrap gap-[4rem] items-center justify-center " >
                    {
                        faqData.map((faq) => (
                            <div className="flex flex-col shadow-[0px_0px_48px_-6px_#ffffff40]   gap-[1rem] w-[40%] p-[2rem] rounded-[5px] bg-gray-800 hover:scale-[1.02] transition-all cursor-pointer  " key={faq.id} >
